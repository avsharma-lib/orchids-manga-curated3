        ...
        <div className="flex h-20 items-center justify-between">
          {/* Logo */}
            <Link href="/" className="group relative">
              <Image 
                src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/2a47d37b-9ee1-436f-a523-d1a159358ad0/IMG_20260203_174240_759-1770132469064.png?width=800&height=800&resize=contain"
                alt="Inkai"
                width={180}
                height={60}
