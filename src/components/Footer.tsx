        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          {/* Brand */}
            <div className="md:col-span-2">
              ...
              <p className="text-[var(--stone)] max-w-sm leading-relaxed text-sm">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[var(--mist)]">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+910000000000" className="hover:text-[var(--paper)] transition-colors">+91 00000 00000</a>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:hello@inkai.com" className="hover:text-[var(--paper)] transition-colors">hello@inkai.com</a>
              </li>
